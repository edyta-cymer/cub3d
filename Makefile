...
SRC_FILES   = init_data.c init_txr_colors.c utils.c validate.c map.c draw_wall.c cub_math.c flood_fill.c init_mlx.c mlx_put_line.c init_ray.c raycaster.c controls.c main.c
